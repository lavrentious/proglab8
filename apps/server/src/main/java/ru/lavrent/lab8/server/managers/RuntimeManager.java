...
import ru.lavrent.lab8.server.TCPServer;
import ru.lavrent.lab8.server.commands.Add;
import ru.lavrent.lab8.server.commands.Clear;
import ru.lavrent.lab8.server.commands.Command;
import ru.lavrent.lab8.server.commands.CountLessThanDifficulty;
import ru.lavrent.lab8.server.commands.DeleteById;
import ru.lavrent.lab8.server.commands.Info;
import ru.lavrent.lab8.server.commands.Show;
import ru.lavrent.lab8.server.commands.UpdateById;
import ru.lavrent.lab8.server.database.DBSessionManager;
import ru.lavrent.lab8.server.utils.ServerEnvConfig;
...
public class RuntimeManager {
  ...
  private void setupLogger() {
    ...
    logger = Logger.getLogger("ru.lavrent.lab8.server");
  ...
  private void loadCommands() {
    Command[] commands = new Command[] {
        ...
        new UpdateById(this.collectionManager),
        new DeleteById(this.collectionManager),
